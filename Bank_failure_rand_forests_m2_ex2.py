...
COURSERA_TOKEN="zdM9FQqUDfVmg5AF"
...
single_tree = DecisionTreeClassifier(max_depth=5,min_samples_split=50,class_weight="balanced",min_impurity_split=0.1,min_samples_leaf=0.01)
...
clf = RandomForestClassifier(max_depth=5,n_estimators=1000,max_features=0.5,random_state=42)
### END CODE HERE ###
...
COURSERA_TOKEN="bDDbrZkal1kHBkwC"
### GRADED PART (DO NOT EDIT) ###
...
# ... please set random_state=42 in a random forest classifier of sklearn
gbt = GradientBoostingClassifier(min_samples_split=5,n_estimators=500,learning_rate=0.05,max_depth=4,max_features=1.0,random_state=42)
### END CODE HERE ###
if gbt is not None:
